...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>  
 <?php
include("./data/facebook_metadata.php");?>
  <title>AGrowingCommunity.org</title>
	<meta name="title" content="AGrowingCommunity.org" />
	<meta name="description" content="AGrowingCommunity lets you connect to people in your area, find and follow news from local community groups, and work with others to discuss, share, conserve and co-operate, to foster more vibrant, resilient communities." />
	...
	<meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0;"> 
		...
		<link href="./css/HtmlControl.css" rel="stylesheet" type="text/css">
		...
		<?php	
			if ($_SERVER['HTTP_HOST'] == 'theveggiebox.org' || $_SERVER['HTTP_HOST'] == 'www.theveggiebox.org') {
				print('<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAiflk3RC59GlSewXxvZDrIhSKjjOOwOf6Deakv_c0W5fk5OntFRTpe1ELMDcNTMf2mODmqKh0DXLlcw" type="text/javascript"></script>' . "\n");
			}
			else if ($_SERVER['HTTP_HOST'] == 'agrowingcommunity.org' || $_SERVER['HTTP_HOST'] == 'www.agrowingcommunity.org') {
				print('<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAA0DfdGjlGDDT7I6yi_1JrlxSoo8lXEzg-M7_Ch5nwoLCndX9HaxQAlTeW_OlkcleAuMgU6afSPkQCfA" type="text/javascript"></script>' . "\n");
			}
		?>

		<!--<script src="http://www.google.com/uds/api?file=uds.js&amp;v=1.0" type="text/javascript"></script>-->
		<script src="./javascript/ClusterMarker.js" type="text/javascript"></script>
		<script src="./javascript/HtmlControl.js" type="text/javascript"></script>
		<script src="./javascript/veggie-box.js" type="text/javascript"></script>
  ...
  <div id="header"> 	
	<div id="header_center">
		...
		<div id="header-tool-bar" class="fg-toolbar ui-widget-header ui-corner-all ui-helper-clearfix">
			...
			<div id="header_login_large"  style="margin: 0px;">
				<div class="show_logged_in fg-buttonset fg-buttonset-single ui-helper-clearfix">		
					<a id="logOutButton2" href="#" class="fg-button ui-state-default ui-corner-left" title="Logout">Logout <span id="your_name2"></span></a>
					<a id="settingsButton" href="#" class="fg-button ui-state-default ui-corner-right" title="Settings">Settings</a>
				</div>
		...
		<div id="panel_center">
			<div id="panel_home" class="content_pane" style="overflow: auto; padding-top: 1em;">
				...
				<div style="float: right; clear: both; width: 250px; margin: 0.4em 0 0.4em 0.6em; padding: 0.4em 0.4em 0.4em 0.8em" class="ui-corner-all ui-widget-content"><b>See it in action:</b><br>See the site being used in Brunswick, Melbourne...<button type="button" class="fg-button ui-corner-all ui-state-default" style="float: right; margin: 0.6em" onclick="application.panelManager.gotoAddress('brunswick, melbourne', application.resourceManager.widgetRunSearch);$('#accordion').accordion( 'activate' , 1); return(false);">Go</button></div>
				<p style="font-size: 1.2em;">AGrowingCommunity.org lets you add, find and connect with community resources, services and groups in the area around you. The network is a community built and run resource that supports more resilient, sustainable communities. <a href="javascript: application.panelManager.openDocsWindow();">Learn more...</a><br><br> </p> 	
				<div class="" style="padding: 0.4em; margin-right: 2em; width: 50%;" >
					...
					<form id="home goto"class="" onsubmit="application.panelManager.gotoAddress(this.address.value, application.resourceManager.widgetRunSearch);return(false);">
								...
								<button type="button" class="fg-button ui-corner-all ui-state-default" onclick="application.panelManager.gotoAddress(this.form.address.value, application.resourceManager.widgetRunSearch);">Go</button>
					</form>
					<br/>
					<div id="error_load_message" class="ui-widget">
							<div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em; margin-top: 20px;"> 
								<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span>
									Sorry, we're having dificulty loading the site on your browser.  This seems to be because you are using an older browser.  Updating your browser is easy, and means your computer will be more secure and run faster.  Download Firefox, which is a great community developed browser, or you can download the lastest Chrome or Internet Explorer.
								</p>
							</div>
					</div>
				</div>
			...
			<div id="panel_inbox" class="content_pane">
				<div id="inbox_tabs" style="margin-bottom: 2em;">	
					<ul>
						...
						<li><a href="#tabs-news" onclick="application.user.refreshInboxRss();">News / Blog / Twitter Feeds</a></li>
					...
					<div id="tabs-news">
						<span class="show_logged_in">
							<div id="message-inbox-controls" style="border-bottom: 1px solid black; height: 2.8em; font-size: 0.8em;">
								<div  style="float: right;" class="fg-buttonset fg-buttonset-multi">
									<a href="#" onclick="" class="fg-button fg-button-icon-left ui-state-default ui-corner-all" title="Remove Feeds"><span class="ui-icon ui-icon-circle-close"></span>Remove Feeds</a>
								</div>
							</div>							
							<div id="inbox_rss_feeds">
							</div><br/>
							<form id=""class="fg-form">
								Enter Feed address 
								<input type="text" class="fg-input ui-corner-all" style="width: 220px;" name="url" value="" />
								<button type="button" class="fg-button fg-button-icon-left ui-corner-all ui-state-default" onclick="application.user.rssAdd(this.form.url.value);application.user.refreshInboxRss();this.form.url.value='';"><span class="ui-icon ui-icon-circle-plus"></span>Add Feed</button>
							</form>
						</span>
						<span class="show_logged_out">
							<div class="ui-widget">
								<div class="ui-state-error ui-corner-all" style="padding: 0pt 0.7em; margin-top: 20px;"> 
									<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 0.3em;"></span>
										Sorry, you need to <a href="#" onclick="application.panelManager.openLoginWindow(); return(false);">Login</a> or <a href="#" onclick="application.panelManager.openHomeWindow();return(false);">Sign Up</a> to follow news, twitter and blog feed from groups in your area!
									</p>
								</div>
							</div>
						</span>
			...
			<div id="panel_docs" class="content_pane">
				<div id="tabs_doco">
					<ul> 
						 ...
						 <li><a href="/docs/help"><span>Instructions / Help </span></a></li>
						 <li><a href="/docs/groups.html"><span>Informaion For Groups</span></a></li>
						 <li><a href="/docs/about_us.html"><span>Contact / About Us</span></a></li>
					</ul>
				</div>
			</div>
			<div id="panel_profile" class="content_pane">
			<h1>Profile: <span id="profile_username"></span></h1>
			<p>stuff here...</p>
			</div>
		</div>
		</div>
			...
			<div id="map_filter_center" class="ui-corner-all content_area" >
				...
				<div id="map_filter_search"  >
					<form id="search_form" class="fg-form" onsubmit="application.resourceManager.widgetRunSearch({forceLoad: 1, openExact: 1});return(false);">																										
						...
						<div id="search_subtype_checkboxes" style="display: none;padding: 0.6em;">
						...
						<div id="searchPanelResults" style="height:300px; width: 100%; overflow:auto; display:none;">
							ddddd<div id="searchPanelResultsListings">
							</div>
							<div>
							bla bla
							</div>
		...
		<div id="map_tools_div" class="ui-corner-all">
					<a id="" href="#" class="map-button fg-button ui-state-default fg-button-icon-solo ui-corner-top" style="margin: 0px;" title="Change Location" onclick="$('#map_dialog_location').dialog('open');return(false);"><span class="ui-icon ui-icon-arrow-4"></span>Change Location</a>
					<a id="" href="#" class="map-button fg-button ui-state-default fg-button-icon-solo" style="margin: 0px;" title="Your Voice In House: Contact your local member of parliament " onclick="$('#map_dialog_yvih').dialog('open');return(false);"><span class="ui-icon ui-icon-check"></span>Your Voice In House</a>
					<a id="" href="#" class="map-button fg-button ui-state-default fg-button-icon-solo" style="margin: 0px;" title="Data Feeds: Access data, for currenlty displayed listings, in various formats" onclick="$('#map_dialog_data').dialog('open');return(false);"><span class="ui-icon ui-icon-signal-diag"></span>Data Feeds</a>
					<a id="" href="#" class="map-button fg-button ui-state-default fg-button-icon-solo ui-corner-bottom" style="margin: 0px;" title="Website Plugin: Customise the network for your Website" onclick="$('#map_dialog_plugin').dialog('open');return(false);"><span class="ui-icon ui-icon-image"></span>Website Plugin</a>
		</div>
		<div id="map_div">
		</div>
		...
		<div id="map_dialog_yvih" style="padding: 0.4em 0.8em;">
			Find and Contact your elected state and federal representatives.  Click on your location on the map and click on Contact my Representatives.
		</div>					
		<div id="map_dialog_plugin"style="padding: 0.4em 0.8em;">
			Cut and paste the following code to embed agrowingcommunity into your website.  Use the options below to customise the plugin:
			<input id="wpf_code" type="text" class="fg-input ui-corner-all" style="margin-top: 1em; margin-bottom: 1em; width:95%;" value="<iframe src=&quot;http://www.agrowingcommunity.org/index.php?zoom=' + map.getZoom() + '&lat=' + lat_lng.lat() + '&lng=' + lat_lng.lng() + '&nb=' + nb+ '&eb=' + eb + '&sb=' + sb + '&wb=' + wb + '&lid=' + this.resource_id + '&subtype=' +'&subtype=' + subtype + '&quot; style=&quot;width: ' + width + 'px; height:' + height + 'px; border:none;&quot;></iframe>"  />
			...
			<form id="widget_plugin_form" class="fg-form" >
					...
					<select id="wpf_theme" onchange="application.panelManager.widgetPluginCustomize();" name="theme" class="fg-input ui-corner-all" style="width: 100%; margin-bottom:2px;">
							<option value="">Select Theme</option>
							<option value="">Default</option>
							<option value="le_frog">Tree Frog</option>
							<option value="dark_hive">Melbourne Emo</option>	
					</select><br />
		...
		<div id="map_dialog_data" style="padding: 0.4em 0.8em;">
			<p>The links below provide feeds of all listings matching your current search within the current area.</p>
			<p>
    ...
    <noscript><b>JavaScript must be enabled in order for you to use AGrowingCommunity.org.</b> 
      However, it seems JavaScript is either disabled or not supported by your browser. 
      To view AGrowingCommunity.org, enable JavaScript by changing your browser options, and then 
      try again.
    </noscript>
