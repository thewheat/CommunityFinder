	...
	_init: function() {
		...
		$input.bind(($.browser.opera ? "keypress" : "keydown") + ".autocomplete", function(event) {
			...
			switch(event.keyCode) {
				...
				// HACK: commented out following line as it disallowed entering of new values when in multi mode, that is when you typed a new word that was a substring of an autocomplete suggestion, hitting comma would select that value, not allow the new one.
