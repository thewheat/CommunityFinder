...
$success = mysql_select_db("lukasber_theveggiebox", $link) or die ('I cannot set table because: ' . mysql_error());;
...
$result = mysql_query($query, $link) or die ('I cannot run query because: ' . mysql_error());;
...
while ($row = mysql_fetch_assoc($result)) {
	...
	print('<p><b>' . $row["name"] . ' wrote </b> ' .  $row["comment"] . '</p>' . "\n");
}
